...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.query_text.setMinimumSize(QtCore.QSize(453, 35))
        self.query_text.setMaximumSize(QtCore.QSize(400, 35))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.query_text.setFont(font)
        self.query_text.setObjectName(_fromUtf8("query_text"))
        self.formLayout.setWidget(0, QtGui.QFormLayout.LabelRole, self.query_text)
        ...
        self.formLayout.setWidget(0, QtGui.QFormLayout.FieldRole, self.go_button)
